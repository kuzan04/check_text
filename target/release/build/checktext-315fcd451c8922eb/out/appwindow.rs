# [allow (non_snake_case)] # [allow (non_camel_case_types)] # [allow (clippy :: style)] # [allow (clippy :: complexity)] # [allow (unused_braces , unused_parens)] # [allow (clippy :: erasing_op)] # [allow (clippy :: approx_constant)] # [allow (clippy :: eq_op)] # [allow (clippy :: cmp_owned)] # [allow (clippy :: redundant_clone)] # [allow (clippy :: overly_complex_bool_expr)] mod slint_generatedAppWindow {
     ...
     # [derive (sp :: FieldOffsets , Default)] # [const_field_offset (sp :: const_field_offset)] # [repr (C)] # [pin_drop] struct InnerComponent_rectangle_23 {
         r#rectangle_23 : sp :: r#Empty , r#button_24 : InnerButton_root_65 , r#model_data : sp :: Property < sp :: SharedString > , r#model_index : sp :: Property < i32 > , r#rectangle_23_height : sp :: Property < sp :: LogicalLength > , r#rectangle_23_width : sp :: Property < sp :: LogicalLength > , r#rectangle_23_x : sp :: Property < sp :: LogicalLength > , r#rectangle_23_y : sp :: Property < sp :: LogicalLength > , self_weak : sp :: OnceCell < sp :: VWeakMapped < sp :: ItemTreeVTable , InnerComponent_rectangle_23 >> , parent : sp :: VWeakMapped :: < sp :: ItemTreeVTable , InnerAppWindow > , root : sp :: OnceCell < sp :: VWeak < sp :: ItemTreeVTable , InnerAppWindow >> , tree_index : :: core :: cell :: Cell < u32 > , tree_index_of_first_child : :: core :: cell :: Cell < u32 > , }
     ...
     impl r#AppWindow {
         ...
         # [allow (dead_code)] pub fn get_lines (& self) -> sp :: ModelRc < sp :: SharedString > {
             # [allow (unused_imports)] let _self = sp :: VRc :: as_pin_ref (& self . 0) ;
             ({
                 * & InnerAppWindow :: FIELD_OFFSETS . r#root_1_lines }
            ) . apply_pin (_self) . get () }
         # [allow (dead_code)] pub fn set_lines (& self , value : sp :: ModelRc < sp :: SharedString >) {
             # [allow (unused_imports)] let _self = sp :: VRc :: as_pin_ref (& self . 0) ;
             ({
                 * & InnerAppWindow :: FIELD_OFFSETS . r#root_1_lines }
